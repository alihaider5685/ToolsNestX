        ...
        <div className="mx-auto max-w-screen-2xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-8xl text-lg leading-8 text-gray-400">
              ...
              Beautify, format and validate JSON instantly with one click.
              Make JSON data clean, readable and error-free directly in your
        ...
        <div className="mx-auto max-w-screen-2xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-8xl text-lg leading-8 text-gray-400">
              ...
              Beautify, validate and organize JSON data instantly. Perfect for
              developers, students, API testing and debugging with a fast,
              secure and browser-based experience.
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Convert compressed JSON into clean, properly indented and easy-to-read code.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Detect formatting errors and validate JSON before using it in applications.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                All formatting happens locally in your browser without uploading your data.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Ideal for APIs, configuration files, databases and software development.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Format even large JSON documents within seconds using your browser.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Use the JSON Formatter & Validator as often as you need without any cost.
          ...
          <div className="mt-20 grid gap-10 md:grid-cols-3">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-10 text-center">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Paste your JSON data into the input editor or type it directly.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-10 text-center">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Click the Format button to beautify your JSON and instantly validate its structure.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-10 text-center">
              ...
              <p className="mt-5 max-w-8xl leading-8 text-gray-400">
                ...
                Copy the formatted JSON or download it for use in your applications.
        ...
        <div className="mx-auto max-w-screen-2xl">
          ...
          <div className="mx-auto max-w-8xl space-y-8 text-lg leading-9 text-gray-400">
            ...
            <p>
              ...
              Our tool also validates JSON syntax while formatting it, allowing
              you to quickly identify structural errors before using your data
              in applications. This saves time during development and improves
              productivity when working with APIs and web services.
        ...
        <div className="mx-auto max-w-screen-2xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-8xl text-lg leading-8 text-gray-400">
              ...
              Find answers to the most common questions about our JSON Formatter & Validator.
          ...
          <div className="mx-auto mt-16 max-w-5xl space-y-5">
            ...
            {[
              ...
              },
              {
                ...
                a: "Yes. The tool checks your JSON and reports formatting or syntax errors before beautifying it.",
              },
              {
                q: "Is my JSON uploaded anywhere?",
                a: "No. Everything runs locally inside your browser for maximum privacy.",
              },
              {
                q: "Can I format large JSON files?",
                a: "Yes. The formatter can process large JSON documents quickly depending on your browser and device.",
              },
              {
              ...
              },
              {
                ...
                a: "Developers, students, API testers, database administrators and anyone working with JSON data.",
              },
            ].map((item) => (
          ...
          <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:border-blue-500/40">
              ...
              <p className="mt-4 leading-7 text-gray-400">
                ...
                Encode plain text or files into Base64 instantly.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:border-blue-500/40">
              ...
              <p className="mt-4 leading-7 text-gray-400">
                ...
                Decode Base64 encoded content back into readable text.
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:border-blue-500/40">
              ...
              <p className="mt-4 leading-7 text-gray-400">
                ...
                Encode and decode URLs safely for web development.
